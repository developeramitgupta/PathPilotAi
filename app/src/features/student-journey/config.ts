...
export const studentJourneyConfig: Record<StudentJourney, StudentJourneyConfig> = {
  "stream-explorer": {
    ...
    navigation: [
      ...
      { label: "Build", items: [{ label: "Skills & Activities", href: "/learning", icon: BookOpenCheck }, { label: "Mission", href: "/mission", icon: Flag }, { label: "Timeline", href: "/timeline", icon: Clock3 }] },
    ...
    allowedRoutePrefixes: [...baseRoutes, "/career-discovery", "/roadmap", "/learning", "/mission", "/timeline"],
  ...
  "education-planner": {
    ...
    navigation: [
      ...
      { label: "Plan", items: [{ label: "Roadmap", href: "/roadmap", icon: Route }, { label: "Career Simulator", href: "/simulator", icon: BarChart3 }, { label: "Mission", href: "/mission", icon: Flag }, { label: "Timeline", href: "/timeline", icon: Clock3 }] },
      { label: "Account", items: [{ label: "Settings", href: "/settings", icon: Settings }] },
    ],
    ...
    allowedRoutePrefixes: [...baseRoutes, "/career-discovery", "/degrees", "/colleges", "/exams", "/roadmap", "/mission", "/simulator", "/timeline"],
  ...
  "career-launch": {
    ...
    navigation: [
      { label: "Launch", items: [{ label: "Home", href: "/dashboard", icon: LayoutDashboard }, { label: "Career Direction", href: "/career-discovery", icon: Compass }, { label: "Roadmap", href: "/roadmap", icon: Route }, { label: "Career Simulator", href: "/simulator", icon: BarChart3 }, { label: "Timeline", href: "/timeline", icon: Clock3 }, { label: "Learning Coach", href: "/learning", icon: BookOpenCheck }] },
    ...
    allowedRoutePrefixes: [...baseRoutes, "/career-discovery", "/roadmap", "/learning", "/projects", "/resume", "/github", "/interview", "/opportunities", "/degrees", "/simulator", "/timeline"],
